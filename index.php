...
$sql = "SELECT DISTINCT Category FROM sp16_newsCategory nc INNER JOIN sp16_newsFeed nf ON nc.CategoryID = nf.CategoryID";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $sql2 = "SELECT FeedName, FeedID FROM sp16_newsFeed nf INNER JOIN sp16_newsCategory nc ON nc.CategoryID = nf.CategoryID WHERE Category = '$category'";
